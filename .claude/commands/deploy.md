...
2. Backend — Cloudflare Worker (`firstbridge-analytics-api`)
3. Frontend — Vite production build + Cloudflare Pages (`firstbridge-analytics`)
4. Shopify app config — syncs `shopify.app.toml` to the Partner dashboard
...
### 4. Deploy frontend to Cloudflare Pages (production branch)
